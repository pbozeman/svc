...
def extract_from_vcd(vcd_file):
    ...
    return prog, dmem, spec_checks, reg_checks
...
def main():
    ...
    #
    # Extract spec checks and reg checks from VCD (need timing info)
    #
    _, _, spec_checks, reg_checks = extract_from_vcd(vcd_file)
